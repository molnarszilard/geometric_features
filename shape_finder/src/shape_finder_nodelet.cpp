...
int main(int argc, char **argv)
{
    ...
    ShapeFinderNodelet sf;
    ros::spin();
}
//PLUGINLIB_DECLARE_CLASS(shape_finder, shape_finder_nodelet, shape_finder::shape_finder_nodelet, nodelet::Nodelet);